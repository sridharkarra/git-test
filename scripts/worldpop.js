...
//$(document).ready(function() {
    ...
    function getCountryPop(){
        ...
        $.ajax("https://api.population.io:443/1.0/population/" + searchCountry + "/today-and-tomorrow/")
            .done(function(list) { //[0]
    ...
    function getCurrentPop() {
        ...
        if (searchYear < dt){
                $.ajax("https://api.population.io:443/1.0/population/" + searchYear + "/" + searchCountry+"/")
                    .done(function(list) { //[0]
